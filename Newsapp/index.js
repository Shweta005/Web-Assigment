...
fetch(
  "https://gnews.io/api/v4/top-headlines?&token=95c93c67729e33391949a8952ef678ec"
)
  .then((response) => {
  ...
  .then((data) => {
    ...
    for (let r of data.articles) { //can use map() also
      tab += `<tr> 
  ...
  and display news related to selected value.****************************/
    ...
    fetch(`https://gnews.io/api/v4/search?q=${str}&token=95c93c67729e33391949a8952ef678ec`)//1de7e656585a4edb9d1b28c6cfcfef78
    .then(response =>{
    console.log(response);
    return response.json();
    }).then(data =>{
